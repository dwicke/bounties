...
This experiment consisted of randomly placing 300 tasks, 1 goal location, and 8 robots on the field and then running the experiment for 20000 time steps.  Due to the excessive computation time greedy approach was not used.
