 ...
 * @author drew
 */
public class CooperativeTaskBondsman extends Bondsman {
    ...
    int adjBounty[];
    int numAdj;
    public CooperativeTaskBondsman() {
        
    }

    public CooperativeTaskBondsman(Bounties bounties, int exclusiveType) {
        super(bounties, exclusiveType);
        prevAgentCount = new int[bounties.numTasks];
        adjBounty = new int[bounties.numTasks];
        numAdj = 0;
